...
import com.wtl.constants.Constants;
import com.wtl.exception.BaseException;
import com.wtl.utils.Reflections;
...
/**
 * 实现类BaseService，
 * 以后的开发中，Service接口实现Service<T>，Service实现类继承BaseService<T>。
 *
 * @author wangtianlong 2019/3/19 19:12
 * @version 1.0
 */
public abstract class BaseServiceImpl<T> implements BaseService<T> {
    ...
    @Transactional(rollbackFor = Exception.class)
    public int delete(String ids) { return mapper.deleteByIds(ids); }
    ...
    /**
     * 检查乐观锁<br>
     * 更新失败时，抛出 UpdateFailedException 异常（该异常未定义）
     *
